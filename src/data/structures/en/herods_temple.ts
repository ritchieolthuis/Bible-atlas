...
export const herods_temple: Structure = {
  ...
  hotspots: [
    {
      id: "sanctuary",
      title: "The Holy of Holies & Sanctuary",
      short: "Dwelling of God and the torn veil",
      detail: "And the veil of the temple was rent in twain from the top to the bottom (Mark 15:38). Here stood the majestic white marble and gold sanctuary.",
      category: "facade",
    ...
    {
      id: "treasury",
      title: "The Treasury (Court of Women)",
      short: "Where the poor widow cast in two mites",
      detail: "And Jesus sat over against the treasury, and beheld how the people cast money into the treasury... And there came a certain poor widow, and she threw in two mites (Mark 12:41-42).",
      category: "court",
    ...
    },
    {
      ...
      short: "Temple cleansing and house of prayer",
      detail: "And Jesus went into the temple, and began to cast out them that sold and bought in the temple... Is it not written, My house shall be called of all nations the house of prayer? (Mark 11:15,17).",
      category: "court",
    ...
    },
    {
      ...
      short: "Covered royal colonnade of the apostles",
      detail: "And Jesus walked in the temple in Solomon's porch (John 10:23). And they were all with one accord in Solomon's porch (Acts 5:12).",
      category: "structure",
    ...
    },
    {
      ...
      short: "Where the lame man was healed",
      detail: "And a certain man lame from his mother's womb was carried, whom they laid daily at the gate of the temple which is called Beautiful (Acts 3:2).",
      category: "entrance",
