    ...
    rooms: [
      {
        ...
        verse: "\"And the LORD God planted a garden eastward in Eden\", Genesis 2:8 (KJV)",
      },
      {
        name: "The Tree of Life",
        note: "Set in the midst of the garden",
        verse: "\"the tree of life also in the midst of the garden\", Genesis 2:9 (KJV)",
      },
      {
        name: "The Tree of Knowledge of Good and Evil",
        note: "The one tree forbidden to Adam, on pain of death",
        verse: "\"thou shalt not eat of it: for in the day that thou eatest thereof thou shalt surely die\", Genesis 2:17 (KJV)",
      },
      {
        name: "Pison and Havilah",
        note: "The first head of the river, compassing a land of gold",
        verse: "\"The name of the first is Pison: that is it which compasseth the whole land of Havilah, where there is gold\", Genesis 2:11 (KJV)",
      },
      {
        name: "Gihon, Hiddekel, and Euphrates",
        note: "The remaining three heads of the river",
        verse: "\"And the name of the second river is Gihon... And the name of the third river is Hiddekel... and the fourth river is Euphrates\", Genesis 2:13-14 (KJV)",
      },
    ],
  },
  artifacts: {
